...
SELECT
   ...
   TO_CHAR(DRUG_EXPOSURE_START_DATETIME, 'YYYY-MM-DD HH24:MI:SS') as DRUG_EXPOSURE_START_DATETIME,
   TO_CHAR(DRUG_EXPOSURE_END_DATE, 'YYYY-MM-DD HH24:MI:SS') as DRUG_EXPOSURE_END_DATE,
   TO_CHAR(DRUG_EXPOSURE_END_DATETIME, 'YYYY-MM-DD HH24:MI:SS') as DRUG_EXPOSURE_END_DATETIME,
...
(select 
   ...
   (select count(*) from PERSON p JOIN @cohortDatabaseSchema.N3C_COHORT n ON p.PERSON_ID = n.PERSON_ID) as ROW_COUNT
from DUAL
...
select 
   ...
   (select count(*) from OBSERVATION_PERIOD op JOIN @cohortDatabaseSchema.N3C_COHORT n ON op.PERSON_ID = n.PERSON_ID AND OBSERVATION_PERIOD_START_DATE >= '01-JAN-2018') as ROW_COUNT
from DUAL
...
select 
   ...
   (select count(*) from VISIT_OCCURRENCE vo JOIN @cohortDatabaseSchema.N3C_COHORT n ON vo.PERSON_ID = n.PERSON_ID AND VISIT_START_DATE >= '01-JAN-2018') as ROW_COUNT
from DUAL
...
select 
   ...
   (select count(*) from CONDITION_OCCURRENCE co JOIN @cohortDatabaseSchema.N3C_COHORT n ON co.PERSON_ID = n.PERSON_ID AND CONDITION_START_DATE >= '01-JAN-2018') as ROW_COUNT
from DUAL
...
select 
   ...
   (select count(*) from DRUG_EXPOSURE de JOIN @cohortDatabaseSchema.N3C_COHORT n ON de.PERSON_ID = n.PERSON_ID AND DRUG_EXPOSURE_START_DATE >= '01-JAN-2018') as ROW_COUNT
from DUAL
...
select 
   ...
   (select count(*) from PROCEDURE_OCCURRENCE po JOIN @cohortDatabaseSchema.N3C_COHORT n ON po.PERSON_ID = n.PERSON_ID AND PROCEDURE_DATE >= '01-JAN-2018') as ROW_COUNT
from DUAL
...
select 
   ...
   (select count(*) from MEASUREMENT m JOIN @cohortDatabaseSchema.N3C_COHORT n ON m.PERSON_ID = n.PERSON_ID AND MEASUREMENT_DATE >= '01-JAN-2018') as ROW_COUNT
from DUAL
...
select 
   ...
   (select count(*) from OBSERVATION o JOIN @cohortDatabaseSchema.N3C_COHORT n ON o.PERSON_ID = n.PERSON_ID AND OBSERVATION_DATE >= '01-JAN-2018') as ROW_COUNT
from DUAL
...
select 
   ...
   (select count(*) from DRUG_ERA de JOIN @cohortDatabaseSchema.N3C_COHORT n ON de.PERSON_ID = n.PERSON_ID AND DRUG_ERA_START_DATE >= '01-JAN-2018') as ROW_COUNT
from DUAL
...
select 
   ...
   (select count(*) from DOSE_ERA ds JOIN @cohortDatabaseSchema.N3C_COHORT n ON ds.PERSON_ID = n.PERSON_ID AND DOSE_ERA_START_DATE >= '01-JAN-2018') as ROW_COUNT
from DUAL
