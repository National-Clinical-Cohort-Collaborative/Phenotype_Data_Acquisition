...
SELECT
   ...
   CONVERT(VARCHAR(20),CONDITON_END_DATETIME, 120) as CONDITION_END_DATETIME,
...
WHERE DOSE_ERA_START_DATE >= '1/1/2018';
...
SELECT
   ...
   PERSON_ID,
   CONDITION_CONCEPT_ID,
   CONVERT(VARCHAR(20),CONDITON_ERA_START_DATE, 120) as CONDITION_ERA_START_DATE,
...
select 
   ...
   (select count(*) from OBSERVATION_PERIOD op JOIN @cohortDatabaseSchema.N3C_COHORT n ON op.PERSON_ID = n.PERSON_ID AND OBSERVATION_PERIOD_START_DATE >= '1/1/2018') as ROW_COUNT

UNION

select 
   'VISIT_OCCURRENCE' as TABLE_NAME,
   (select count(*) from VISIT_OCCURRENCE vo JOIN @cohortDatabaseSchema.N3C_COHORT n ON vo.PERSON_ID = n.PERSON_ID AND VISIT_START_DATE >= '1/1/2018') as ROW_COUNT

UNION

select 
   'CONDITION_OCCURRENCE' as TABLE_NAME,
   (select count(*) from CONDITION_OCCURRENCE co JOIN @cohortDatabaseSchema.N3C_COHORT n ON co.PERSON_ID = n.PERSON_ID AND CONDITION_START_DATE >= '1/1/2018') as ROW_COUNT

UNION

select 
   'DRUG_EXPOSURE' as TABLE_NAME,
   (select count(*) from DRUG_EXPOSURE de JOIN @cohortDatabaseSchema.N3C_COHORT n ON de.PERSON_ID = n.PERSON_ID AND DRUG_EXPOSURE_START_DATE >= '1/1/2018') as ROW_COUNT

UNION

select 
   'PROCEDURE_OCCURRENCE' as TABLE_NAME,
   (select count(*) from PROCEDURE_OCCURRENCE po JOIN @cohortDatabaseSchema.N3C_COHORT n ON po.PERSON_ID = n.PERSON_ID AND PROCEDURE_DATE >= '1/1/2018') as ROW_COUNT

UNION
   
select 
   'MEASUREMENT' as TABLE_NAME,
   (select count(*) from MEASUREMENT m JOIN @cohortDatabaseSchema.N3C_COHORT n ON m.PERSON_ID = n.PERSON_ID AND MEASUREMENT_DATE >= '1/1/2018') as ROW_COUNT

UNION

select 
   'OBSERVATION' as TABLE_NAME,
   (select count(*) from OBSERVATION o JOIN @cohortDatabaseSchema.N3C_COHORT n ON o.PERSON_ID = n.PERSON_ID AND OBSERVATION_DATE >= '1/1/2018') as ROW_COUNT
...
select 
   ...
   (select count(*) from DRUG_ERA de JOIN @cohortDatabaseSchema.N3C_COHORT n ON de.PERSON_ID = n.PERSON_ID AND DRUG_ERA_START_DATE >= '1/1/2018') as ROW_COUNT
...
select 
   ...
   (select count(*) from CONDITION_ERA JOIN @cohortDatabaseSchema.N3C_COHORT ON CONDITION_ERA.PERSON_ID = N3C_COHORT.PERSON_ID AND CONDITION_ERA_START_DATE >= '1/1/2018') as ROW_COUNT
) s;
