...
(select 
   ...
   (select count(*) from PERSON) as ROW_COUNT
from DUAL

UNION

select 
   'OBSERVATION_PERIODATION' as TABLE_NAME,
   (select count(*) from OBSERVATION_PERIOD) as ROW_COUNT
from DUAL
...
select 
   ...
   (select count(*) from VISIT_OCCURRENCE) as ROW_COUNT
from DUAL
...
select 
   ...
   (select count(*) from CONDITION_OCCURRENCE) as ROW_COUNT
from DUAL
...
select 
   ...
   (select count(*) from DRUG_EXPOSURE) as ROW_COUNT
from DUAL
...
select 
   ...
   (select count(*) from PROCEDURE_OCCURRENCE) as ROW_COUNT
from DUAL
...
select 
   ...
   (select count(*) from MEASUREMENT) as ROW_COUNT
from DUAL
...
select 
   ...
   (select count(*) from OBSERVATION) as ROW_COUNT
from DUAL
...
select 
   ...
   (select count(*) from DRUG_ERA) as ROW_COUNT
from DUAL
...
select 
   ...
   (select count(*) from DOSE_ERA) as ROW_COUNT
from DUAL
...
select 
   ...
   (select count(*) from CONDITION_ERA) as ROW_COUNT
from DUAL);
