...
select 
   ...
   (select count(*) from LAB_RESULT_CM JOIN N3C_COHORT ON LAB_RESULT_CM.PATID = N3C_COHORT.PATID AND (LAB_ORDER_DATE >= '1/1/2018' OR ADMIT_DATE >= '1/1/2018')) as ROW_COUNT
