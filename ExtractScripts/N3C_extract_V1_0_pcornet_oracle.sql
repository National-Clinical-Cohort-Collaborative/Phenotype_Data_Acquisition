...
(select 
   ...
   (select count(*) from DEMOGRAPHIC) as ROW_COUNT
from DUAL
...
select 
   ...
   (select count(*) from ENCOUNTER) as ROW_COUNT
from DUAL
...
select 
   ...
   (select count(*) from CONDITION) as ROW_COUNT
from DUAL
...
select 
   'DEATH' as TABLE_NAME,
   (select count(*) from DEATH) as ROW_COUNT
from DUAL
...
select 
   ...
   (select count(*) from DEATH_CAUSE) as ROW_COUNT
from DUAL
...
select 
   ...
   (select count(*) from DIAGNOSIS) as ROW_COUNT
from DUAL
...
select 
   ...
   (select count(*) from DISPENSING) as ROW_COUNT
from DUAL
...
select 
   ...
   (select count(*) from IMMUNIZATION) as ROW_COUNT
from DUAL
...
select 
   ...
   (select count(*) from LAB_RESULT_CM) as ROW_COUNT
from DUAL
...
select 
   ...
   (select count(*) from LDS_ADDRESS_HISTORY) as ROW_COUNT
from DUAL
...
select 
   ...
   (select count(*) from MED_ADMIN) as ROW_COUNT
from DUAL
...
select 
   ...
   (select count(*) from OBS_CLIN) as ROW_COUNT
from DUAL
...
select 
   ...
   (select count(*) from OBS_GEN) as ROW_COUNT
from DUAL
...
select 
   ...
   (select count(*) from PRESCRIBING) as ROW_COUNT
from DUAL
...
select 
   ...
   (select count(*) from PRO_CM) as ROW_COUNT
from DUAL
...
select 
   'VITAL' as TABLE_NAME,
   (select count(*) from VITAL) as ROW_COUNT
from DUAL);
