...
select
   ...
   CAST( (CURRENT_DATE + -2*INTERVAL'1 day') as date) as UPDATE_DATE,	--change integer based on your site's data latency
   CAST( (CURRENT_DATE + 3*INTERVAL'1 day') as date) as NEXT_SUBMISSION_DATE;
