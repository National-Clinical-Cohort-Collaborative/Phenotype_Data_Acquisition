...
JOIN @resultsDatabaseSchema.N3C_COHORT n
  ...
  WHERE co.CONDITION_START_DATE >= '01-JAN-2018' ;
...
JOIN (SELECT DISTINCT cs.LOCATION_ID
...
FROM @cdmDatabaseSchema.DOSE_ERA y JOIN @resultsDatabaseSchema.N3C_COHORT n ON y.PERSON_ID = N.PERSON_ID
  WHERE y.DOSE_ERA_START_DATE >= '01-JAN-2018' ;
...
SELECT * FROM (SELECT 'PERSON' as TABLE_NAME,
 ...
 FROM DUAL  UNION SELECT 'OBSERVATION_PERIOD'  TABLE_NAME,
   (SELECT count(*) FROM @cdmDatabaseSchema.OBSERVATION_PERIOD op JOIN @resultsDatabaseSchema.N3C_COHORT n ON op.PERSON_ID = n.PERSON_ID AND OBSERVATION_PERIOD_START_DATE >= '01-JAN-2018' ) as ROW_COUNT

  FROM DUAL  UNION SELECT 'VISIT_OCCURRENCE'  TABLE_NAME,
   (SELECT count(*) FROM @cdmDatabaseSchema.VISIT_OCCURRENCE vo JOIN @resultsDatabaseSchema.N3C_COHORT n ON vo.PERSON_ID = n.PERSON_ID AND VISIT_START_DATE >= '01-JAN-2018' ) as ROW_COUNT

  FROM DUAL  UNION SELECT 'CONDITION_OCCURRENCE'  TABLE_NAME,
   (SELECT count(*) FROM @cdmDatabaseSchema.CONDITION_OCCURRENCE co JOIN @resultsDatabaseSchema.N3C_COHORT n ON co.PERSON_ID = n.PERSON_ID AND CONDITION_START_DATE >= '01-JAN-2018' ) as ROW_COUNT

  FROM DUAL  UNION SELECT 'DRUG_EXPOSURE'  TABLE_NAME,
   (SELECT count(*) FROM @cdmDatabaseSchema.DRUG_EXPOSURE de JOIN @resultsDatabaseSchema.N3C_COHORT n ON de.PERSON_ID = n.PERSON_ID AND DRUG_EXPOSURE_START_DATE >= '01-JAN-2018' ) as ROW_COUNT

  FROM DUAL  UNION SELECT 'PROCEDURE_OCCURRENCE'  TABLE_NAME,
   (SELECT count(*) FROM @cdmDatabaseSchema.PROCEDURE_OCCURRENCE po JOIN @resultsDatabaseSchema.N3C_COHORT n ON po.PERSON_ID = n.PERSON_ID AND PROCEDURE_DATE >= '01-JAN-2018' ) as ROW_COUNT

  FROM DUAL  UNION SELECT 'MEASUREMENT'  TABLE_NAME,
   (SELECT count(*) FROM @cdmDatabaseSchema.MEASUREMENT m JOIN @resultsDatabaseSchema.N3C_COHORT n ON m.PERSON_ID = n.PERSON_ID AND MEASUREMENT_DATE >= '01-JAN-2018' ) as ROW_COUNT

  FROM DUAL  UNION SELECT 'OBSERVATION'  TABLE_NAME,
   (SELECT count(*) FROM @cdmDatabaseSchema.OBSERVATION o JOIN @resultsDatabaseSchema.N3C_COHORT n ON o.PERSON_ID = n.PERSON_ID AND OBSERVATION_DATE >= '01-JAN-2018' ) as ROW_COUNT
  ...
  FROM DUAL  UNION SELECT 'DRUG_ERA'  TABLE_NAME,
   (SELECT count(*) FROM @cdmDatabaseSchema.DRUG_ERA de JOIN @resultsDatabaseSchema.N3C_COHORT n ON de.PERSON_ID = n.PERSON_ID AND DRUG_ERA_START_DATE >= '01-JAN-2018' ) as ROW_COUNT
   /**
UNION

select
   'DOSE_ERA' as TABLE_NAME,
   (select count(*) from DOSE_ERA ds JOIN @resultsDatabaseSchema.N3C_COHORT n ON ds.PERSON_ID = n.PERSON_ID AND DOSE_ERA_START_DATE >= '01-JAN-2018') as ROW_COUNT
   **/
  FROM DUAL   UNION select
   'CONDITION_ERA'  TABLE_NAME,
   (SELECT count(*) FROM @cdmDatabaseSchema.CONDITION_ERA JOIN @resultsDatabaseSchema.N3C_COHORT ON CONDITION_ERA.PERSON_ID = N3C_COHORT.PERSON_ID AND CONDITION_ERA_START_DATE >= '01-JAN-2018' ) as ROW_COUNT
  FROM DUAL ) s ;
