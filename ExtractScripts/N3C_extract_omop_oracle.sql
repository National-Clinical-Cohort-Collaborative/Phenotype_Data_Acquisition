...
SELECT * FROM (SELECT 'PERSON' as TABLE_NAME,
 ...
 FROM DUAL  UNION SELECT 'OBSERVATION_PERIOD'  TABLE_NAME,
  ...
  FROM DUAL  UNION (SELECT count(*) FROM @cdmDatabaseSchema.DEATH d JOIN @resultsDatabaseSchema.N3C_COHORT n ON d.PERSON_ID = n.PERSON_ID AND DEATH_DATE >= '1/1/2020' )  ROW_COUNT
