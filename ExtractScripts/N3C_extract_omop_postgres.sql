...
select
   ...
   CONVERT(VARCHAR(20), CURRENT_DATE, 120) as RUN_DATE,
   CONVERT(VARCHAR(20), CURRENT_DATE -2, 120) as UPDATE_DATE,		--change integer based on your site's data latency
   CONVERT(VARCHAR(20), CURRENT_DATE +3, 120) as NEXT_SUBMISSION_DATE;