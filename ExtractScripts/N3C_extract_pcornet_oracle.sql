...
(SELECT 'DEMOGRAPHIC' as TABLE_NAME, 
 ...
 FROM DUAL  UNION SELECT 'ENCOUNTER'  TABLE_NAME,
   (SELECT count(*) FROM @cdmDatabaseSchema.ENCOUNTER JOIN @resultsDatabaseSchema.N3C_COHORT ON ENCOUNTER.PATID = N3C_COHORT.PATID AND ADMIT_DATE >= '01-JAN-2018' ) as ROW_COUNT

  FROM DUAL  UNION SELECT 'CONDITION'  TABLE_NAME,
   (SELECT count(*) FROM @cdmDatabaseSchema.CONDITION JOIN @resultsDatabaseSchema.N3C_COHORT ON CONDITION.PATID = N3C_COHORT.PATID AND REPORT_DATE >= '01-JAN-2018' ) as ROW_COUNT
  ...
  FROM DUAL  UNION SELECT 'DIAGNOSIS'  TABLE_NAME,
   (SELECT count(*) FROM @cdmDatabaseSchema.DIAGNOSIS JOIN @resultsDatabaseSchema.N3C_COHORT ON DIAGNOSIS.PATID = N3C_COHORT.PATID AND (DX_DATE >= '01-JAN-2018' OR ADMIT_DATE >= '01-JAN-2018') ) as ROW_COUNT

  FROM DUAL  UNION SELECT 'DISPENSING'  TABLE_NAME,
   (SELECT count(*) FROM @cdmDatabaseSchema.DISPENSING JOIN @resultsDatabaseSchema.N3C_COHORT ON DISPENSING.PATID = N3C_COHORT.PATID AND DISPENSE_DATE >= '01-JAN-2018' ) as ROW_COUNT
  ...
  FROM DUAL  UNION SELECT 'LAB_RESULT_CM'  TABLE_NAME,
   (SELECT count(*) FROM @cdmDatabaseSchema.LAB_RESULT_CM JOIN @resultsDatabaseSchema.N3C_COHORT ON LAB_RESULT_CM.PATID = N3C_COHORT.PATID AND (LAB_ORDER_DATE >= '01-JAN-2018' OR RESULT_DATE >= '01-JAN-2018') ) as ROW_COUNT
  ...
  FROM DUAL  UNION SELECT 'MED_ADMIN'  TABLE_NAME,
   (SELECT count(*) FROM @cdmDatabaseSchema.MED_ADMIN JOIN @resultsDatabaseSchema.N3C_COHORT ON MED_ADMIN.PATID = N3C_COHORT.PATID AND MEDADMIN_START_DATE >= '01-JAN-2018' ) as ROW_COUNT

  FROM DUAL  UNION SELECT 'OBS_CLIN'  TABLE_NAME,
   (SELECT count(*) FROM @cdmDatabaseSchema.OBS_CLIN JOIN @resultsDatabaseSchema.N3C_COHORT ON OBS_CLIN.PATID = N3C_COHORT.PATID AND OBSCLIN_DATE >= '01-JAN-2018' ) as ROW_COUNT

  FROM DUAL  UNION SELECT 'OBS_GEN'  TABLE_NAME,
   (SELECT count(*) FROM @cdmDatabaseSchema.OBS_GEN JOIN @resultsDatabaseSchema.N3C_COHORT ON OBS_GEN.PATID = N3C_COHORT.PATID and OBSGEN_DATE >= '01-JAN-2018' ) as ROW_COUNT

  FROM DUAL  UNION SELECT 'PRESCRIBING'  TABLE_NAME,
   (SELECT count(*) FROM @cdmDatabaseSchema.PRESCRIBING JOIN @resultsDatabaseSchema.N3C_COHORT ON PRESCRIBING.PATID = N3C_COHORT.PATID AND RX_START_DATE >= '01-JAN-2018' ) as ROW_COUNT

  FROM DUAL  UNION SELECT 'PRO_CM'  TABLE_NAME,
   (SELECT count(*) FROM @cdmDatabaseSchema.PRO_CM JOIN @resultsDatabaseSchema.N3C_COHORT ON PRO_CM.PATID = N3C_COHORT.PATID AND PRO_DATE >= '01-JAN-2018' ) as ROW_COUNT

  FROM DUAL  UNION SELECT 'PROCEDURES'  TABLE_NAME,
   (SELECT count(*) FROM @cdmDatabaseSchema.PROCEDURES JOIN @resultsDatabaseSchema.N3C_COHORT ON PROCEDURES.PATID = N3C_COHORT.PATID AND PX_DATE >= '01-JAN-2018' ) as ROW_COUNT
  ...
  FROM DUAL   UNION select 
   'VITAL'  TABLE_NAME,
   (SELECT count(*) FROM @cdmDatabaseSchema.VITAL JOIN @resultsDatabaseSchema.N3C_COHORT ON VITAL.PATID = N3C_COHORT.PATID AND MEASURE_DATE >= '01-JAN-2018' ) as ROW_COUNT
  FROM DUAL );
