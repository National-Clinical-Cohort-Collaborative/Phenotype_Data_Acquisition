...
DROP TABLE IF EXISTS :TNX_SCHEMA.n3c_note;
DROP TABLE IF EXISTS :TNX_SCHEMA.n3c_note_nlp;

---------------------------------------------------------------------------------------------------------
-- CREATE TABLES
---------------------------------------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS :TNX_SCHEMA.n3c_note (
	NOTE_ID						VARCHAR(200)
...
CREATE TABLE IF NOT EXISTS :TNX_SCHEMA.n3c_note_nlp (
...
INSERT INTO :TNX_SCHEMA.n3c_note 
SELECT
...
INSERT INTO :TNX_SCHEMA.n3c_note_nlp
SELECT DISTINCT
...
FROM :TNX_SCHEMA.n3c_note n3c_note
...
INSERT INTO :TNX_SCHEMA.n3c_data_counts SELECT 'Note', count(1) FROM :TNX_SCHEMA.n3c_note;
INSERT INTO :TNX_SCHEMA.n3c_data_counts SELECT 'Note NLP', count(1) FROM :TNX_SCHEMA.n3c_note_nlp;
COMMIT;
