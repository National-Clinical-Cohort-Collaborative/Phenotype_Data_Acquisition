...
FROM (
	...
	AND 
	(	-- Strong DX List
		mp.mt_code IN ('UMLS:ICD10CM:B97.21', 'UMLS:ICD10CM:U07.1')
		-- special handling for B97.29
		OR (mp.mt_code IN ('UMLS:ICD10CM:B97.29') AND dx.date < '2020-04-01')
	)
	---------------------------------------------------------------------------------------------------------
	...
	FROM (
		...
		(	-- Weak DX List - Individual Codes
			mp.mt_code IN ('UMLS:ICD10CM:Z20.828', 'UMLS:ICD10CM:B34.2', 'UMLS:ICD10CM:J06.9', 'UMLS:ICD10CM:J98.8', 'UMLS:ICD10CM:R43.0', 'UMLS:ICD10CM:R43.2', 'UMLS:ICD10CM:R07.1', 'UMLS:ICD10CM:R68.83')
			-- special handling for B97.29
			OR (mp.mt_code IN ('UMLS:ICD10CM:B97.29') AND dx.date >= '2020-04-01')
	...
	AND 
	(	-- PX List
		mp.mt_code IN ('UMLS:HCPCS:U0001', 'UMLS:HCPCS:U0002', 'UMLS:CPT:87635', 'UMLS:CPT:86318', 'UMLS:CPT:86328', 'UMLS:CPT:86769')
	)
	---------------------------------------------------------------------------------------------------------
	...
	AND 
	(	-- LOINC List
		mp.mt_code IN ('UMLS:LNC:94307-6','UMLS:LNC:94308-4','UMLS:LNC:94309-2','UMLS:LNC:94310-0','UMLS:LNC:94311-8','UMLS:LNC:94312-6','UMLS:LNC:94313-4','UMLS:LNC:94314-2','UMLS:LNC:94315-9','UMLS:LNC:94316-7','UMLS:LNC:94500-6','UMLS:LNC:94502-2','UMLS:LNC:94505-5','UMLS:LNC:94506-3','UMLS:LNC:94507-1','UMLS:LNC:94508-9','UMLS:LNC:94509-7','UMLS:LNC:94510-5','UMLS:LNC:94511-3','UMLS:LNC:94532-9','UMLS:LNC:94533-7','UMLS:LNC:94534-5','UMLS:LNC:94547-7','UMLS:LNC:94558-4','UMLS:LNC:94559-2','UMLS:LNC:94562-6','UMLS:LNC:94563-4','UMLS:LNC:94564-2','UMLS:LNC:94565-9','UMLS:LNC:94639-2','UMLS:LNC:94640-0','UMLS:LNC:94641-8','UMLS:LNC:94642-6','UMLS:LNC:94643-4','UMLS:LNC:94644-2','UMLS:LNC:94645-9','UMLS:LNC:94646-7','UMLS:LNC:94647-5','UMLS:LNC:94660-8','UMLS:LNC:94661-6','UMLS:LNC:94306-8','UMLS:LNC:94503-0','UMLS:LNC:94504-8','UMLS:LNC:94531-1','UMLS:LNC:94720-0','UMLS:LNC:94758-0','UMLS:LNC:94759-8','UMLS:LNC:94760-6','UMLS:LNC:94762-2','UMLS:LNC:94763-0','UMLS:LNC:94764-8','UMLS:LNC:94765-5','UMLS:LNC:94766-3','UMLS:LNC:94767-1','UMLS:LNC:94768-9','UMLS:LNC:94769-7','UMLS:LNC:94819-0')
		--OTHER LAB
