...
SELECT 'LOINC:94763-0 POSITIVE' AS LOINC FROM DUAL UNION
SELECT 'LOINC:94762-2 POSITIVE' AS LOINC FROM DUAL UNION
SELECT 'LOINC:94558-4 POSITIVE' AS LOINC FROM DUAL UNION
SELECT 'LOINC:94562-6 POSITIVE' AS LOINC FROM DUAL UNION
SELECT 'LOINC:94768-9 POSITIVE' AS LOINC FROM DUAL UNION
SELECT 'LOINC:95125-1 POSITIVE' AS LOINC FROM DUAL UNION
SELECT 'LOINC:94761-4 POSITIVE' AS LOINC FROM DUAL UNION
SELECT 'LOINC:94563-4 POSITIVE' AS LOINC FROM DUAL UNION
SELECT 'LOINC:94507-1 POSITIVE' AS LOINC FROM DUAL UNION
SELECT 'LOINC:94547-7 POSITIVE' AS LOINC FROM DUAL UNION
SELECT 'LOINC:95416-4 POSITIVE' AS LOINC FROM DUAL UNION
SELECT 'LOINC:94564-2 POSITIVE' AS LOINC FROM DUAL UNION
SELECT 'LOINC:94508-9 POSITIVE' AS LOINC FROM DUAL UNION
SELECT 'LOINC:94760-6 POSITIVE' AS LOINC FROM DUAL UNION
SELECT 'LOINC:95409-9 POSITIVE' AS LOINC FROM DUAL UNION
SELECT 'LOINC:94533-7 POSITIVE' AS LOINC FROM DUAL UNION
SELECT 'LOINC:94756-4 POSITIVE' AS LOINC FROM DUAL UNION
SELECT 'LOINC:94757-2 POSITIVE' AS LOINC FROM DUAL UNION
SELECT 'LOINC:94766-3 POSITIVE' AS LOINC FROM DUAL UNION
SELECT 'LOINC:94316-7 POSITIVE' AS LOINC FROM DUAL UNION
SELECT 'LOINC:94307-6 POSITIVE' AS LOINC FROM DUAL UNION
SELECT 'LOINC:94308-4 POSITIVE' AS LOINC FROM DUAL UNION
SELECT 'LOINC:95411-5 POSITIVE' AS LOINC FROM DUAL UNION
SELECT 'LOINC:94559-2 POSITIVE' AS LOINC FROM DUAL UNION
SELECT 'LOINC:94639-2 POSITIVE' AS LOINC FROM DUAL UNION
SELECT 'LOINC:94534-5 POSITIVE' AS LOINC FROM DUAL UNION
SELECT 'LOINC:94314-2 POSITIVE' AS LOINC FROM DUAL UNION
SELECT 'LOINC:94565-9 POSITIVE' AS LOINC FROM DUAL UNION
SELECT 'LOINC:94759-8 POSITIVE' AS LOINC FROM DUAL UNION
SELECT 'LOINC:95406-5 POSITIVE' AS LOINC FROM DUAL UNION
SELECT 'LOINC:94500-6 POSITIVE' AS LOINC FROM DUAL UNION
SELECT 'LOINC:94845-5 POSITIVE' AS LOINC FROM DUAL UNION
SELECT 'LOINC:94822-4 POSITIVE' AS LOINC FROM DUAL UNION
SELECT 'LOINC:94660-8 POSITIVE' AS LOINC FROM DUAL UNION
SELECT 'LOINC:94309-2 POSITIVE' AS LOINC FROM DUAL UNION
SELECT 'LOINC:94640-0 POSITIVE' AS LOINC FROM DUAL UNION
SELECT 'LOINC:94767-1 POSITIVE' AS LOINC FROM DUAL UNION
SELECT 'LOINC:94641-8 POSITIVE' AS LOINC FROM DUAL UNION
SELECT 'LOINC:95825-6 POSITIVE' AS LOINC FROM DUAL UNION
SELECT 'LOINC:95542-7 POSITIVE' AS LOINC FROM DUAL UNION
SELECT 'LOINC:96119-3 POSITIVE' AS LOINC FROM DUAL UNION
SELECT 'LOINC:95425-5 POSITIVE' AS LOINC FROM DUAL UNION
SELECT 'LOINC:96448-6 POSITIVE' AS LOINC FROM DUAL UNION
SELECT 'LOINC:95824-9 POSITIVE' AS LOINC FROM DUAL UNION
SELECT 'LOINC:96120-1 POSITIVE' AS LOINC FROM DUAL UNION
SELECT 'LOINC:96091-4 POSITIVE' AS LOINC FROM DUAL UNION
SELECT 'LOINC:96123-5 POSITIVE' AS LOINC FROM DUAL UNION
SELECT 'LOINC:95608-6 POSITIVE' AS LOINC FROM DUAL UNION
SELECT 'LOINC:95424-8 POSITIVE' AS LOINC FROM DUAL UNION
SELECT 'LOINC:95609-4 POSITIVE' AS LOINC FROM DUAL UNION
SELECT 'LOINC:96603-6 POSITIVE' AS LOINC FROM DUAL UNION
SELECT 'LOINC:95970-0 POSITIVE' AS LOINC FROM DUAL UNION
SELECT 'LOINC:95971-8 POSITIVE' AS LOINC FROM DUAL UNION
SELECT 'LOINC:96121-9 POSITIVE' AS LOINC FROM DUAL UNION
SELECT 'LOINC:95823-1 POSITIVE' AS LOINC FROM DUAL UNION
SELECT 'LOINC:96122-7 POSITIVE' AS LOINC FROM DUAL UNION
SELECT 'LOINC:97097-0 POSITIVE' AS LOINC FROM DUAL UNION
SELECT 'LOINC:96763-8 POSITIVE' AS LOINC FROM DUAL UNION
SELECT 'LOINC:96957-6 POSITIVE' AS LOINC FROM DUAL UNION
SELECT 'LOINC:96986-5 POSITIVE' AS LOINC FROM DUAL UNION
SELECT 'LOINC:96958-4 POSITIVE' AS LOINC FROM DUAL UNION
SELECT 'LOINC:97098-8 POSITIVE' AS LOINC FROM DUAL UNION
SELECT 'LOINC:96797-6 POSITIVE' AS LOINC FROM DUAL UNION
SELECT 'LOINC:96829-7 POSITIVE' AS LOINC FROM DUAL UNION
SELECT 'LOINC:96765-3 POSITIVE' AS LOINC FROM DUAL UNION
SELECT 'LOINC:96752-1 POSITIVE' AS LOINC FROM DUAL UNION
SELECT 'LOINC:98069-8 POSITIVE' AS LOINC FROM DUAL UNION
SELECT 'LOINC:98132-4 POSITIVE' AS LOINC FROM DUAL UNION
SELECT 'LOINC:98494-8 POSITIVE' AS LOINC FROM DUAL UNION
SELECT 'LOINC:98131-6 POSITIVE' AS LOINC FROM DUAL UNION
SELECT 'LOINC:98493-0 POSITIVE' AS LOINC FROM DUAL UNION
SELECT 'LOINC:99596-9 POSITIVE' AS LOINC FROM DUAL UNION
SELECT 'LOINC:99597-7 POSITIVE' AS LOINC FROM DUAL UNION
SELECT 'LOINC:99772-6 POSITIVE' AS LOINC FROM DUAL UNION
...
SELECT 'LOINC:94767-1' AS LOINC FROM DUAL UNION
SELECT 'LOINC:94641-8' AS LOINC FROM DUAL UNION
SELECT 'LOINC:95825-6' AS LOINC FROM DUAL UNION
SELECT 'LOINC:95542-7' AS LOINC FROM DUAL UNION
SELECT 'LOINC:96119-3' AS LOINC FROM DUAL UNION
SELECT 'LOINC:95425-5' AS LOINC FROM DUAL UNION
SELECT 'LOINC:96448-6' AS LOINC FROM DUAL UNION
SELECT 'LOINC:95824-9' AS LOINC FROM DUAL UNION
SELECT 'LOINC:96120-1' AS LOINC FROM DUAL UNION
SELECT 'LOINC:96091-4' AS LOINC FROM DUAL UNION
SELECT 'LOINC:96123-5' AS LOINC FROM DUAL UNION
SELECT 'LOINC:95608-6' AS LOINC FROM DUAL UNION
SELECT 'LOINC:95424-8' AS LOINC FROM DUAL UNION
SELECT 'LOINC:95609-4' AS LOINC FROM DUAL UNION
SELECT 'LOINC:96603-6' AS LOINC FROM DUAL UNION
SELECT 'LOINC:95970-0' AS LOINC FROM DUAL UNION
SELECT 'LOINC:95971-8' AS LOINC FROM DUAL UNION
SELECT 'LOINC:96121-9' AS LOINC FROM DUAL UNION
SELECT 'LOINC:95823-1' AS LOINC FROM DUAL UNION
SELECT 'LOINC:96122-7' AS LOINC FROM DUAL UNION
SELECT 'LOINC:97097-0' AS LOINC FROM DUAL UNION
SELECT 'LOINC:96763-8' AS LOINC FROM DUAL UNION
SELECT 'LOINC:96957-6' AS LOINC FROM DUAL UNION
SELECT 'LOINC:96986-5' AS LOINC FROM DUAL UNION
SELECT 'LOINC:96958-4' AS LOINC FROM DUAL UNION
SELECT 'LOINC:97098-8' AS LOINC FROM DUAL UNION
SELECT 'LOINC:96797-6' AS LOINC FROM DUAL UNION
SELECT 'LOINC:96829-7' AS LOINC FROM DUAL UNION
SELECT 'LOINC:96765-3' AS LOINC FROM DUAL UNION
SELECT 'LOINC:96752-1' AS LOINC FROM DUAL UNION
SELECT 'LOINC:98069-8' AS LOINC FROM DUAL UNION
SELECT 'LOINC:98132-4' AS LOINC FROM DUAL UNION
SELECT 'LOINC:98494-8' AS LOINC FROM DUAL UNION
SELECT 'LOINC:98131-6' AS LOINC FROM DUAL UNION
SELECT 'LOINC:98493-0' AS LOINC FROM DUAL UNION
SELECT 'LOINC:99596-9' AS LOINC FROM DUAL UNION
SELECT 'LOINC:99597-7' AS LOINC FROM DUAL UNION
SELECT 'LOINC:99772-6' AS LOINC FROM DUAL UNION
--codes in ACT ontology and your concept_dimension table
...
FROM (
 SELECT p.patient_num, p.race_cd AS race_cd, p.birth_date AS birth_date, p.sex_cd AS sex_cd, 
  ...
  obs.concept_cd AS ethnicity_cd from @cdmDatabaseSchema.patient_dimension p
