--Phenotype 4.0
--ACT
--This script was tested with the following indexes and OBSERVATION_FACT.act partitioned on concept_cd and the following indexes
--CONCEPT_DIMENSION 
-- CONCEPT_CD
-- CONCEPT_PATH
...
SELECT '95209-3 POSITIVE' AS LOINC FROM DUAL UNION
SELECT '94763-0 POSITIVE' AS LOINC FROM DUAL UNION
SELECT '94762-2 POSITIVE' AS LOINC FROM DUAL UNION
SELECT '94558-4 POSITIVE' AS LOINC FROM DUAL UNION
SELECT '94562-6 POSITIVE' AS LOINC FROM DUAL UNION
SELECT '94768-9 POSITIVE' AS LOINC FROM DUAL UNION
SELECT '95125-1 POSITIVE' AS LOINC FROM DUAL UNION
SELECT '94761-4 POSITIVE' AS LOINC FROM DUAL UNION
SELECT '94563-4 POSITIVE' AS LOINC FROM DUAL UNION
SELECT '94507-1 POSITIVE' AS LOINC FROM DUAL UNION
SELECT '94547-7 POSITIVE' AS LOINC FROM DUAL UNION
SELECT '95416-4 POSITIVE' AS LOINC FROM DUAL UNION
SELECT '94564-2 POSITIVE' AS LOINC FROM DUAL UNION
SELECT '94508-9 POSITIVE' AS LOINC FROM DUAL UNION
SELECT '94760-6 POSITIVE' AS LOINC FROM DUAL UNION
SELECT '95409-9 POSITIVE' AS LOINC FROM DUAL UNION
SELECT '94533-7 POSITIVE' AS LOINC FROM DUAL UNION
SELECT '94756-4 POSITIVE' AS LOINC FROM DUAL UNION
SELECT '94757-2 POSITIVE' AS LOINC FROM DUAL UNION
SELECT '94766-3 POSITIVE' AS LOINC FROM DUAL UNION
SELECT '94316-7 POSITIVE' AS LOINC FROM DUAL UNION
SELECT '94307-6 POSITIVE' AS LOINC FROM DUAL UNION
SELECT '94308-4 POSITIVE' AS LOINC FROM DUAL UNION
SELECT '95411-5 POSITIVE' AS LOINC FROM DUAL UNION
SELECT '94559-2 POSITIVE' AS LOINC FROM DUAL UNION
SELECT '94639-2 POSITIVE' AS LOINC FROM DUAL UNION
SELECT '94534-5 POSITIVE' AS LOINC FROM DUAL UNION
SELECT '94314-2 POSITIVE' AS LOINC FROM DUAL UNION
SELECT '94565-9 POSITIVE' AS LOINC FROM DUAL UNION
SELECT '94759-8 POSITIVE' AS LOINC FROM DUAL UNION
SELECT '95406-5 POSITIVE' AS LOINC FROM DUAL UNION
SELECT '94500-6 POSITIVE' AS LOINC FROM DUAL UNION
SELECT '94845-5 POSITIVE' AS LOINC FROM DUAL UNION
SELECT '94822-4 POSITIVE' AS LOINC FROM DUAL UNION
SELECT '94660-8 POSITIVE' AS LOINC FROM DUAL UNION
SELECT '94309-2 POSITIVE' AS LOINC FROM DUAL UNION
SELECT '94640-0 POSITIVE' AS LOINC FROM DUAL UNION
SELECT '94767-1 POSITIVE' AS LOINC FROM DUAL UNION
SELECT '94641-8 POSITIVE' AS LOINC FROM DUAL UNION
SELECT '95825-6 POSITIVE' AS LOINC FROM DUAL UNION
SELECT '95542-7 POSITIVE' AS LOINC FROM DUAL UNION
SELECT '96119-3 POSITIVE' AS LOINC FROM DUAL UNION
SELECT '95425-5 POSITIVE' AS LOINC FROM DUAL UNION
SELECT '96448-6 POSITIVE' AS LOINC FROM DUAL UNION
SELECT '95824-9 POSITIVE' AS LOINC FROM DUAL UNION
SELECT '96120-1 POSITIVE' AS LOINC FROM DUAL UNION
SELECT '96091-4 POSITIVE' AS LOINC FROM DUAL UNION
SELECT '96123-5 POSITIVE' AS LOINC FROM DUAL UNION
SELECT '95608-6 POSITIVE' AS LOINC FROM DUAL UNION
SELECT '95424-8 POSITIVE' AS LOINC FROM DUAL UNION
SELECT '95609-4 POSITIVE' AS LOINC FROM DUAL UNION
SELECT '96603-6 POSITIVE' AS LOINC FROM DUAL UNION
SELECT '95970-0 POSITIVE' AS LOINC FROM DUAL UNION
SELECT '95971-8 POSITIVE' AS LOINC FROM DUAL UNION
SELECT '96121-9 POSITIVE' AS LOINC FROM DUAL UNION
SELECT '95823-1 POSITIVE' AS LOINC FROM DUAL UNION
SELECT '96122-7 POSITIVE' AS LOINC FROM DUAL UNION
SELECT '97097-0 POSITIVE' AS LOINC FROM DUAL UNION
SELECT '96763-8 POSITIVE' AS LOINC FROM DUAL UNION
SELECT '96957-6 POSITIVE' AS LOINC FROM DUAL UNION
SELECT '96986-5 POSITIVE' AS LOINC FROM DUAL UNION
SELECT '96958-4 POSITIVE' AS LOINC FROM DUAL UNION
SELECT '97098-8 POSITIVE' AS LOINC FROM DUAL UNION
SELECT '96797-6 POSITIVE' AS LOINC FROM DUAL UNION
SELECT '96829-7 POSITIVE' AS LOINC FROM DUAL UNION
SELECT '96765-3 POSITIVE' AS LOINC FROM DUAL UNION
SELECT '96752-1 POSITIVE' AS LOINC FROM DUAL UNION
SELECT '98069-8 POSITIVE' AS LOINC FROM DUAL UNION
SELECT '98132-4 POSITIVE' AS LOINC FROM DUAL UNION
SELECT '98494-8 POSITIVE' AS LOINC FROM DUAL UNION
SELECT '98131-6 POSITIVE' AS LOINC FROM DUAL UNION
SELECT '98493-0 POSITIVE' AS LOINC FROM DUAL UNION
SELECT '99596-9 POSITIVE' AS LOINC FROM DUAL UNION
SELECT '99597-7 POSITIVE' AS LOINC FROM DUAL UNION
SELECT '99772-6 POSITIVE' AS LOINC FROM DUAL UNION
...
SELECT '95416-4' AS LOINC FROM DUAL UNION
...
SELECT '95411-5' AS LOINC FROM DUAL UNION
...
SELECT '95825-6' AS LOINC FROM DUAL UNION
SELECT '95542-7' AS LOINC FROM DUAL UNION
SELECT '96119-3' AS LOINC FROM DUAL UNION
SELECT '95425-5' AS LOINC FROM DUAL UNION
SELECT '96448-6' AS LOINC FROM DUAL UNION
SELECT '95824-9' AS LOINC FROM DUAL UNION
SELECT '96120-1' AS LOINC FROM DUAL UNION
SELECT '96091-4' AS LOINC FROM DUAL UNION
SELECT '96123-5' AS LOINC FROM DUAL UNION
SELECT '95608-6' AS LOINC FROM DUAL UNION
SELECT '95424-8' AS LOINC FROM DUAL UNION
SELECT '95609-4' AS LOINC FROM DUAL UNION
SELECT '96603-6' AS LOINC FROM DUAL UNION
SELECT '95970-0' AS LOINC FROM DUAL UNION
SELECT '95971-8' AS LOINC FROM DUAL UNION
SELECT '96121-9' AS LOINC FROM DUAL UNION
SELECT '95823-1' AS LOINC FROM DUAL UNION
SELECT '96122-7' AS LOINC FROM DUAL UNION
SELECT '97097-0' AS LOINC FROM DUAL UNION
SELECT '96763-8' AS LOINC FROM DUAL UNION
SELECT '96957-6' AS LOINC FROM DUAL UNION
SELECT '96986-5' AS LOINC FROM DUAL UNION
SELECT '96958-4' AS LOINC FROM DUAL UNION
SELECT '97098-8' AS LOINC FROM DUAL UNION
SELECT '96797-6' AS LOINC FROM DUAL UNION
SELECT '96829-7' AS LOINC FROM DUAL UNION
SELECT '96765-3' AS LOINC FROM DUAL UNION
SELECT '96752-1' AS LOINC FROM DUAL UNION
SELECT '98069-8' AS LOINC FROM DUAL UNION
SELECT '98132-4' AS LOINC FROM DUAL UNION
SELECT '98494-8' AS LOINC FROM DUAL UNION
SELECT '98131-6' AS LOINC FROM DUAL UNION
SELECT '98493-0' AS LOINC FROM DUAL UNION
SELECT '99596-9' AS LOINC FROM DUAL UNION
SELECT '99597-7' AS LOINC FROM DUAL UNION
SELECT '99772-6' AS LOINC FROM DUAL UNION
--codes in ACT ontology and your concept_dimension table
...
(
	...
	SELECT 'ICD10CM:U09.9' AS DX_CODE,	'DX_STRONG_POSITIVE' AS DX_CATEGORY FROM DUAL   UNION
