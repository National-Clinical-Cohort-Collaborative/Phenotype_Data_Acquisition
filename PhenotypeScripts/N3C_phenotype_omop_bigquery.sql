...
as (
 ...
 SELECT distinct c.person_id
	...
	,case
		when abs(date_diff(cast(coalesce(date(d.year_of_birth, d.month_of_birth, coalesce(d.day_of_birth,1)),d.birth_datetime) as DATE), CURRENT_DATE(), year)) between 0
				and 4
			then '0-4'
		when abs(date_diff(cast(coalesce(date(d.year_of_birth, d.month_of_birth, coalesce(d.day_of_birth,1)),d.birth_datetime) as DATE), CURRENT_DATE(), year)) between 5
				and 9
			then '5-9'
		when abs(date_diff(cast(coalesce(date(d.year_of_birth, d.month_of_birth, coalesce(d.day_of_birth,1)),d.birth_datetime) as DATE), CURRENT_DATE(), year)) between 10
				and 14
			then '10-14'
		when abs(date_diff(cast(coalesce(date(d.year_of_birth, d.month_of_birth, coalesce(d.day_of_birth,1)),d.birth_datetime) as DATE), CURRENT_DATE(), year)) between 15
				and 19
			then '15-19'
		when abs(date_diff(cast(coalesce(date(d.year_of_birth, d.month_of_birth, coalesce(d.day_of_birth,1)),d.birth_datetime) as DATE), CURRENT_DATE(), year)) between 20
				and 24
			then '20-24'
		when abs(date_diff(cast(coalesce(date(d.year_of_birth, d.month_of_birth, coalesce(d.day_of_birth,1)),d.birth_datetime) as DATE), CURRENT_DATE(), year)) between 25
				and 29
			then '25-29'
		when abs(date_diff(cast(coalesce(date(d.year_of_birth, d.month_of_birth, coalesce(d.day_of_birth,1)),d.birth_datetime) as DATE), CURRENT_DATE(), year)) between 30
				and 34
			then '30-34'
		when abs(date_diff(cast(coalesce(date(d.year_of_birth, d.month_of_birth, coalesce(d.day_of_birth,1)),d.birth_datetime) as DATE), CURRENT_DATE(), year)) between 35
				and 39
			then '35-39'
		when abs(date_diff(cast(coalesce(date(d.year_of_birth, d.month_of_birth, coalesce(d.day_of_birth,1)),d.birth_datetime) as DATE), CURRENT_DATE(), year)) between 40
				and 44
			then '40-44'
		when abs(date_diff(cast(coalesce(date(d.year_of_birth, d.month_of_birth, coalesce(d.day_of_birth,1)),d.birth_datetime) as DATE), CURRENT_DATE(), year)) between 45
				and 49
			then '45-49'
		when abs(date_diff(cast(coalesce(date(d.year_of_birth, d.month_of_birth, coalesce(d.day_of_birth,1)),d.birth_datetime) as DATE), CURRENT_DATE(), year)) between 50
				and 54
			then '50-54'
		when abs(date_diff(cast(coalesce(date(d.year_of_birth, d.month_of_birth, coalesce(d.day_of_birth,1)),d.birth_datetime) as DATE), CURRENT_DATE(), year)) between 55
				and 59
			then '55-59'
		when abs(date_diff(cast(coalesce(date(d.year_of_birth, d.month_of_birth, coalesce(d.day_of_birth,1)),d.birth_datetime) as DATE), CURRENT_DATE(), year)) between 60
				and 64
			then '60-64'
		when abs(date_diff(cast(coalesce(date(d.year_of_birth, d.month_of_birth, coalesce(d.day_of_birth,1)),d.birth_datetime) as DATE), CURRENT_DATE(), year)) between 65
				and 69
			then '65-69'
		when abs(date_diff(cast(coalesce(date(d.year_of_birth, d.month_of_birth, coalesce(d.day_of_birth,1)),d.birth_datetime) as DATE), CURRENT_DATE(), year)) between 70
				and 74
			then '70-74'
		when abs(date_diff(cast(coalesce(date(d.year_of_birth, d.month_of_birth, coalesce(d.day_of_birth,1)),d.birth_datetime) as DATE), CURRENT_DATE(), year)) between 75
				and 79
			then '75-79'
		when abs(date_diff(cast(coalesce(date(d.year_of_birth, d.month_of_birth, coalesce(d.day_of_birth,1)),d.birth_datetime) as DATE), CURRENT_DATE(), year)) between 80
				and 84
			then '80-84'
		when abs(date_diff(cast(coalesce(date(d.year_of_birth, d.month_of_birth, coalesce(d.day_of_birth,1)),d.birth_datetime) as DATE), CURRENT_DATE(), year)) between 85
				and 89
			then '85-89'
		when abs(date_diff(cast(coalesce(date(d.year_of_birth, d.month_of_birth, coalesce(d.day_of_birth,1)),d.birth_datetime) as DATE), CURRENT_DATE(), year)) >= 90
			then '90+'
		end as pt_age
