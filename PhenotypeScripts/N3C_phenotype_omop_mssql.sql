...
IF OBJECT_ID('@resultsDatabaseSchema.N3C_CONTROL_COHORT', 'U') IS NULL
	CREATE TABLE @resultsDatabaseSchema.N3C_CONTROL_COHORT (
		person_id INT NOT NULL
		,pt_age VARCHAR(20)
		,sex VARCHAR(20)
		,hispanic VARCHAR(20)
...
IF OBJECT_ID('@resultsDatabaseSchema.final_map', 'U') IS NOT NULL
	DROP TABLE @resultsDatabaseSchema.final_map;
